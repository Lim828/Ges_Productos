...
public class MainController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ses.getAttribute("listproduc") == null) {
            ArrayList<Producto> listaux = new ArrayList<Producto>();
            ses.setAttribute("listproduc", listaux);
        }
        ArrayList<Producto> lista = (ArrayList<Producto>) ses.getAttribute("listproduc");
        ...
        switch (opcion) {
            case "nuevo": 
                request.setAttribute("elProducto", obj1);
            ...
            case "eliminar":
                ...
                lista.remove(pos);
                ses.setAttribute("listproduc", lista);
